...
{
	/// <summary>Create a <see cref="ModPacket"/> to write the data in and sending.</summary>
	/// <param name="packetType">Type of packet</param>
	/// <param name="capacity">Capacity of packet in bytes</param>
